...
###  AIR 2519 -GATE CS 2026 | AI | Machine Learning | Deep Learning | Computer Vision | Generative AI 
...
### AI Intern | Infosys Springboard Virtual Internship 7.0
 * Built NetShield AI, an end-to-end network security platform with live packet monitoring and AI-powered threat detection, achieving ~99.7% accuracy and 0.9971 weighted F1-score on CICIDS2017 dataset.
### AI Intern | IBM SkillsBuild & Edunet Foundation 
 * Built PaperMind AI, a multi-document research intelligence platform using Gemini, FAISS, RAG, and LangChain for semantic search, citation-aware Q&A, paper comparison, and research automation.

---

## SKILLS
* Languages: Python, C
* AI/ML: Machine Learning, Deep Learning, Natural Language Processing, Computer Vision, PyTorch, ScikitLearn.
* Generative AI: Prompt Engineering, LLMs, LangChain, Retrieval-Augmented Generation (RAG), FAISS,ChromaDB, Gemini API, Transformers.
* Data Science: Pandas, NumPy
* Tools & Platforms: Git, GitHub, Streamlit, IBM Cloud
